...
#include "monitor.hpp"
#include "xyz/openbmc_project/Fail/Monitor/error.hpp"
...
using namespace sdbusplus::xyz::openbmc_project::Fail::Monitor::Error;
...
bool Monitor::inFailedState(const std::string&& path)
{
    ...
    {
        elog<DBusFailure>(xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          FAIL("Failed reading ActiveState DBus property"),
                          xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          PATH(path.c_str()));
    }
...
std::string Monitor::getSourceUnitPath()
{
    ...
    {
        elog<DBusFailure>(xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          FAIL("Failed GetUnit DBus method call"),
                          xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          PATH(source.c_str()));
    }
...
void Monitor::runTargetAction()
{
    ...
    {
        elog<DBusFailure>(xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          FAIL("Failed to run action on the target unit"),
                          xyz::openbmc_project::Fail::Monitor::DBusFailure::
                          PATH(target.c_str()));
    }
}
