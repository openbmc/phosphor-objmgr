 ...
 *
 * Use getSubTree and return only the dbus object that is in the endpoint of
 * associationPath.
 *
...
std::vector<InterfaceMapType::value_type>
    getAssociatedSubTree(const InterfaceMapType& interfaceMap,
                         ...
                         const std::string& reqPath, int32_t depth,
                         std::vector<std::string>& interfaces)
{
 ...
 * @param interfaces       Interface filter
 *
 * Use getSubTreePaths and return only the dbus object that is in the endpoint
 * of associationPath.
 *
 * @return std::vector<std::string>
 */
std::vector<std::string>
    getAssociatedSubTreePaths(const InterfaceMapType& interfaceMap,
                              const std::string& associationPath,
                              const std::string& reqPath, int32_t depth,
                              std::vector<std::string>& interfaces)
{
...
int main()
{
    ...
    iface->register_method(
        ...
        [&interfaceMap](const std::string& associationPath, std::string reqPath,
                        int32_t depth, std::vector<std::string>& interfaces) {
